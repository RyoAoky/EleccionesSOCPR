...
module.exports = {
    async getexportarinformeconsolidado(req, res) {
        try {
            ...
            if (Array.isArray(citas_id) && citas_id.length > 0) {
                ...
                for (const id of citas_id) {
                    ...
                    for (const codigo of examenes) {
                                ...
                                switch (codigo) {
                                    ...
                                    case '001':
                                        if (objresponse.pb_001 !== 'N' && objresponse.pb_001 !== 'SIN RESULTADOS') {
                                            ...
                                            const { medapmn, des_esp, med_cmp, med_firma, nomarch } = dataJSON[0];
                                    ...
                                    case '003':
                                        if (objresponse.pb_003 !== 'N' && objresponse.pb_003 !== 'SIN RESULTADOS') {
                                            ...
                                            const { tiem_exp_hrs, apre_ruido, logoaudiometria_oido_der,
                                                ...
                                                ante_audio, medapmn, des_esp, med_cmp, med_firma, nomarch } = dataJSON[0];
                                    ...
                                    case '004':
                                        if (objresponse.pb_004 !== 'N' && objresponse.pb_004 !== 'SIN RESULTADOS') {
                                            ...
                                            let { ce_pre1, ce_pre2, ce_pre3, ce_pre4, ce_pre5, ce_pre6, ce_pre7, ce_pre8, ce_pre9, ce_pre10, ce_pre11, ce_pre12, ce_pre13,
                                                ce_pre14, ce_pre15, ce_pre16, ce_pre17, ce_pre18, ce_pre19, ce_pre20, ce_pre21, ce_pre22, ce_pre23, ce_pre24, ce_pre25,
                                                ce_pre26, ce_pre27, ce_pre21_rpta
                                            } = dataJSON[0];
                                            const { nomarch } = dataJSON[0];


                                            if (ce_pre21 === 'SI') {
                                                ce_pre21_rpta = 'CANTIDAD: ' + ce_pre21_rpta;
                                            }
                                            else {
                                                ce_pre21_rpta = '';
                                            }
                                    ...
                                    case '005':
                                        if (objresponse.pb_005 !== 'N' && objresponse.pb_005 !== 'SIN RESULTADOS') {
                                            ...
                                            const { antecedenteMed, medapmn, des_esp, med_cmp, med_firma, Calidad, conclusion, std_fuma, nomarch } = dataJSON[0];
                                        ...
                                        break;
                                    case '006':
                                        if (objresponse.pb_006 !== 'N' && objresponse.pb_006 !== 'SIN RESULTADOS') {
                                            const dataJSON = JSON.parse(objresponse.pb_006);
                                            const { usa_lentes, ultima_act, Reconoce_colores, Refraccion, hallazgos, antecedentes, conclusion, nomarch, medapmn, des_esp, med_cmp, med_firma } = dataJSON[0];

                                            let [usa_lentesSi, usa_lentesNo] = ['', ''];
                                            if (usa_lentes !== 'N') {
                                                usa_lentesSi = 'X'
                                            } else {
                                                usa_lentesNo = 'X'
                                            ...
                                            let [P, S, T] = ['', '', '', ''];
                                            if (Reconoce_colores === 'P') {
                                                P = 'X';
                                            } else if (Reconoce_colores === 'S') {
                                                S = 'X';
                                            } else if (Reconoce_colores === 'T') {
                                                T = 'X';
                                            }
                                            const agudeza_visualArray = JSON.parse(dataJSON[0].agudeza_visual);


                                            const RefraccionData = JSON.parse(Refraccion);
                                            let lodesfera = RefraccionData.lodesfera;
                                            let lodcilindro = RefraccionData.lodcilindro;
                                            let lodeje = RefraccionData.lodeje;
                                            let lodav = RefraccionData.lodav;
                                            let loiesfera = RefraccionData.loiesfera;
                                            let loicilindro = RefraccionData.loicilindro;
                                            let loieje = RefraccionData.loieje;
                                            let loiav = RefraccionData.loiav;
                                            let loddip = RefraccionData.loddip;

                                            let codesfera = RefraccionData.codesfera;
                                            let codcilindro = RefraccionData.codcilindro;
                                            let codeje = RefraccionData.codeje;
                                            let codav = RefraccionData.codav;
                                            let coiesfera = RefraccionData.coiesfera;
                                            let coicilindro = RefraccionData.coicilindro;
                                            let coieje = RefraccionData.coieje;
                                            let coiav = RefraccionData.coiav;
                                            let coddip = RefraccionData.coddip;

                                            let ArrayTestOftalmologia = [];
                                            dataJSON.forEach((objTest) => {
                                                let { desexadet, resultado_test } = objTest;
                                                ArrayTestOftalmologia.push({ desexadet, resultado_test });
                                            });
                                            if (dataJSON[0].diagnosticos && dataJSON[0].diagnosticos.length > 0) {
                                                dataJSON[0].diagnosticos.forEach((objdiagnosticos) => {
                                                    let { diacod, diades } = objdiagnosticos;
                                            ...
                                            data = {
                                                ...
                                                lodesfera: lodesfera,
                                                lodcilindro: lodcilindro,
                                                lodeje: lodeje,
                                                lodav: lodav,
                                                loiesfera: loiesfera,
                                                loicilindro: loicilindro,
                                                loieje: loieje,
                                                loiav: loiav,
                                                loddip: loddip,
                                                codesfera: codesfera,
                                                ...
                                                codav: codav,
                                                coiesfera: coiesfera,
                                                coicilindro: coicilindro,
                                                coieje: coieje,
                                                coiav: coiav,
                                                coddip: coddip,

                                                ArrayTestOftalmologia: ArrayTestOftalmologia,
                                                P: P,
                                                S: S,
                                                T: T,
                                                hallazgos: hallazgos,
                                    ...
                                    case '009':
                                        if (objresponse.pb_009 !== 'N' && objresponse.pb_009 !== 'SIN RESULTADOS') {
                                            ...
                                            if (codpru_id1 && parexa_id1) {
                                                ...
                                                if (doc_adjunto !== '0' && doc_adjunto.length > 0) {
                                                    const doc_adjunto_array = JSON.parse(doc_adjunto);
                                                    let rutaArchivo;
                                                    for (const archivo of doc_adjunto_array) {
                                                        try {
                                                            rutaArchivo = archivo.ruta;
                                                            const tipoExtension = rutaArchivo.split('.').pop().toLowerCase();
                                                            const filePath = path.join(__dirname, '..', 'public', rutaArchivo);
                                                            if (tipoExtension === 'pdf') {
                                                                const docAdjBuffer = await fs.readFile(filePath);
                                                                const docAdjPdf = await PDFDocument.load(docAdjBuffer);
                                                                const copiedPages = await mainPdfDoc.copyPages(docAdjPdf, docAdjPdf.getPageIndices());
                                                                copiedPages.forEach((page) => mainPdfDoc.addPage(page));
                                                            } else if (['png', 'jpg', 'jpeg'].includes(tipoExtension)) {
                                                                ...
                                                                // Calcular dimensiones del contenido de la página
                                                                const contentWidth = page.getWidth() - margins.left - margins.right;
                                                                const contentHeight = page.getHeight() - margins.top - margins.bottom;

                                                                // Calcular las dimensiones ajustadas de la imagen para mantener la relación de aspecto
                                                                let newWidth = contentWidth;
                                                                let newHeight = (imageDims.height / imageDims.width) * newWidth;
                                                                ...
                                                                // Calcular las coordenadas para centrar la imagen dentro del área de contenido
                                                                const x = margins.left + (contentWidth - newWidth) / 2;
                                                                const y = margins.bottom + (contentHeight - newHeight) / 2;
                                                                ...
                                                                const imagePdfDoc = await PDFDocument.load(pdfBytes);
                                                                const copiedImagePages = await mainPdfDoc.copyPages(imagePdfDoc, imagePdfDoc.getPageIndices());
                                                                copiedImagePages.forEach((page) => mainPdfDoc.addPage(page));
                                                            }
                                                        } catch (error) {
                                                            if (error.code === 'ENOENT') {
                                                                console.warn(`El Documento Adjunto ${rutaArchivo} no se encontró. Continuando con el siguiente examen.`);
                                                            } else {
                                                                throw error;
                                                            }
                                                        }
                                    ...
                                    case '013':
                                        if (objresponse.pb_013 !== 'N' && objresponse.pb_013 !== 'SIN RESULTADOS') {
                                            ...
                                            for (const obj of resultadoArray) {
                                                ...
                                                let [conclusion, det_informe, medapmn, des_esp, med_cmp, med_firma, nomarch, codigo_ref, desexadet] =
                                                    [obj.conclusion, obj.det_informe, obj.medapmn, obj.des_esp,
                                                    obj.med_cmp, obj.med_firma, obj.nomarch, obj.codigo_ref, obj.desexadet.toUpperCase()];
                                                ...
                                                if (doc_adjuntoDiag !== '0' && doc_adjuntoDiag.length > 0) {
                                                    const doc_adjunto_array = JSON.parse(doc_adjuntoDiag);
                                                    let rutaArchivo;
                                                    for (const doc_adjunto of doc_adjunto_array) {
                                                        try {
                                                            rutaArchivo = doc_adjunto.ruta;
                                                            const tipoExtension = rutaArchivo.split('.').pop().toLowerCase();
                                                            const filePath = path.join(__dirname, '..', 'public', rutaArchivo);
                                                            ...
                                                            if (tipoExtension === 'pdf') {
                                                                const docAdjBuffer = await fs.readFile(filePath);
                                                                const docadjPdf = await PDFDocument.load(docAdjBuffer);
                                                                const copiedPages = await mainPdfDoc1.copyPages(docadjPdf, docadjPdf.getPageIndices());
                                                                copiedPages.forEach((page) => mainPdfDoc1.addPage(page));
                                                            } else if (['png', 'jpg', 'jpeg'].includes(tipoExtension)) {
                                                                const buffer = await fs.readFile(filePath);
                                                                const resizedBuffer = await sharp(buffer)
                                                                    .resize({ fit: 'inside' })
                                                                ...
                                                                const pdfBytes = await pdfDoc.save();
                                                                const imagePdfDoc = await PDFDocument.load(pdfBytes);
                                                                const copiedImagePages = await mainPdfDoc1.copyPages(imagePdfDoc, imagePdfDoc.getPageIndices());
                                                                copiedImagePages.forEach((page) => mainPdfDoc1.addPage(page));
                                                            }
                                                        } catch (error) {
                                                            if (error.code === 'ENOENT') {
                                                                console.warn(`El Documento Adjunto ${rutaArchivo} no se encontró. Continuando con el siguiente examen.`);
                                    ...
                                    case '020':
                                        if (objresponse.pb_020 !== 'N' && objresponse.pb_020 !== 'SIN RESULTADOS') {
                                            ...
                                            const { ant_padre, ant_madre, ant_hermanos, num_hijos_vivos, num_hijos_fallecidos,
                                                ...
                                                nomarch, restricciones, dia, mes, anio, dir_nrodpptoint, nom_urba, DPTO, Provincia,
                                                Distrito } = dataJSON[0];
                                            ...
                                            //let antecedentes_ocupacionalesArray = obtenerArray(dataJSON, "antecedentes_ocupacionales");
                                            let antecedentes_ocupacionalesArray = [];
                                            if (dataJSON[0].antecedentes_ocupacionales && dataJSON[0].antecedentes_ocupacionales.length > 0) {
                                                dataJSON[0].antecedentes_ocupacionales.forEach((objantecedentes_ocupacionales) => {
                                                    let { empresa, area_trabajo, ocupacion, fec_ini, fec_fin, tiempo, pel_ries_ocup, epp } = objantecedentes_ocupacionales;
                                                    antecedentes_ocupacionalesArray.push({ empresa, area_trabajo, ocupacion, fec_ini, fec_fin, tiempo, pel_ries_ocup, epp });
                                                });
                                            } else {
                                                antecedentes_ocupacionalesArray.push({ empresa: '&nbsp;', area_trabajo: '&nbsp;', ocupacion: '&nbsp;', fec_ini: '&nbsp;', fec_fin: '&nbsp;', tiempo: '&nbsp;', pel_ries_ocup: '&nbsp;', epp: '&nbsp;' });
                                            }
                                            ...
                                            if (signos_vitalesArray.length > 0) {
                                    ...
                                    case '032':
                                        if (objresponse.pb_032 !== 'N' && objresponse.pb_032 !== 'SIN RESULTADOS') {
                                            ...
                                            const { mot_eva, superf_id, tiem_lab, prin_riesgos, med_seguridad, historia_familiar, accid_enfer, habitos, otras_observ,
                                                ...
                                                conducta_sexual, nomarch, medapmn, des_esp, med_cmp, med_firma } = dataJSON[0];

                                            let { recomendacionesInforme } = dataJSON[0];

                                            if (recomendacionesInforme === '') {
                                    ...
                                    case '033':
                                        if (objresponse.pb_033 !== 'N' && objresponse.pb_033 !== 'SIN RESULTADOS') {
                                            ...
                                            const { fecing_empresa, aptitud_espalda, medapmn, des_esp, med_cmp, med_firma, nomarch } = dataJSON[0];
                                    ...
                                    case '045':
                                        if (objresponse.pb_045 !== 'N' && objresponse.pb_045 !== 'SIN RESULTADOS') {
                                            ...
                                            const { tipexa_id, con_eva_psicologica, con_radiograficas, con_audiometria,
                                                con_espirometria, con_musculo_esqueletica, con_oftalmologia, con_electrocardiograma } = dataJSON[0];
                                            ...
                                            let laboratorioJson = JSON.parse(LaboratorioArray);
                                            let Hemoglobina, unidHemoglobina, Glucosa, unidGlucosa, Colesterol, unidColesterol, Trigliceridos, unidTrigliceridos, Orina;
                                            if (laboratorioJson.length > 0) {
                                                laboratorioJson.forEach(objLaboratorio => {
                                                    //Para laboratorio externo
                                                    ...
                                                    //Para otra prueba diferente de laboratorio externo
                                                    if (objLaboratorio.parexa_id == 151) {
                                                        let HemoglobinaData = objLaboratorio.result;
                                                        let unidHemoglobinaData = objLaboratorio.unid;
                                                        Hemoglobina = HemoglobinaData;
                                                        unidHemoglobina = unidHemoglobinaData;
                                                    }
                                                    if (objLaboratorio.parexa_id === 235) {
                                                        let GlucosaoData = objLaboratorio.result;
                                                        let unidGlucosaData = objLaboratorio.unid;
                                                        Glucosa = GlucosaoData;
                                                        unidGlucosa = unidGlucosaData;
                                                    }
                                                    if (objLaboratorio.parexa_id == 236) {
                                                        let ColesterolData = objLaboratorio.result;
                                                        let unidColesterolaData = objLaboratorio.unid;
                                                        Colesterol = ColesterolData;
                                                        unidColesterol = unidColesterolaData;
                                                    ...
                                                    if (objLaboratorio.parexa_id == 237) {
                                                        let TrigliceridosData = objLaboratorio.result;
                                                        let unidTrigliceridosData = objLaboratorio.unid;
                                                        Trigliceridos = TrigliceridosData;
                                                        unidTrigliceridos = unidTrigliceridosData;
                                                    ...
                                                    if (objLaboratorio.parexa_id === 214) {
                                                        let resultOrina = objLaboratorio.result;
                                                        Orina = resultOrina;
                                                    }
                                                });
                                            ...
                                            if (dataJSON[0].diagnosticos && dataJSON[0].diagnosticos.length > 0) {
                                                dataJSON[0].diagnosticos.forEach((objdiagnosticos) => {
                                                    let { numDiag, diagnosticos } = objdiagnosticos;
                                                    cie10.push({ numDiag, diagnosticos });
                                                });
                                            } else {
                                                cie10.push({ numDiag: '&nbsp;', diagnosticos: '&nbsp;' });
                                            }
                                            ...
                                            data = {
                                                ...
                                                con_oftalmologia: con_oftalmologia,
                                                con_radiograficas: con_radiograficas,
                                                con_audiometria: con_audiometria,
                                                con_espirometria: con_espirometria,
                                                con_electrocardiograma: con_electrocardiograma,
                                    ...
                                    case '046':
                                        ...
                                        break;
                                    case '048':
                                        if (objresponse.pb_048 !== 'N' && objresponse.pb_048 !== 'SIN RESULTADOS') {
                                            const dataJSON = JSON.parse(objresponse.pb_048);
                                            const resultadoArray = JSON.parse(dataJSON[0].resultado);
                                            for (const obj of resultadoArray) {
                                                let doc_adjuntoDiag = '';
                                                let cie10Img = [];
                        ...
                        if (bandera && codigo !== '013' && codigo !== '048') {
            ...
            res.status(500).send('Error al generar el ZIP ' + error);
        }
    },
            ...
            if (Array.isArray(citas_id) && citas_id.length > 0) {
                ...
                for (const id of citas_id) {
                    ...
                    for (const codigo of examenes) {
                        ...
                        let doc_adjunto = '';
                        let pdfBuffers = [];
                        const pdfBufferStream = new Readable();
                        ...
                        for (const objresponse of response) {
                            ...
                            async function validacion(htmlTemplate, data) {
                                const renderedHtml = mustache.render(htmlTemplate, data);
                                ...
                                const updatedPdfBuffer = await mainPdfDoc.save();
                                // Agregar el buffer del PDF al array
                                pdfBuffers = updatedPdfBuffer;
                            }
                            if (objresponse.cita_id === id) {
                                pacientenombre = appm_nom;

                                let nombreExamenJson = JSON.parse(objresponse.nombreExamen);
                                nombreExamenJson.forEach((objNombreExamen) => {
                                    let { soexa, desexa } = objNombreExamen;
                                    if (codigo === soexa) {
                                        nombreExamen = desexa;
                                    }
                                });
                                switch (codigo) {
                                    ...
                                    case '001':
                                        if (objresponse.pb_001 !== 'N' && objresponse.pb_001 !== 'SIN RESULTADOS') {
                                            ...
                                            await validacion(htmlTemplate, data);

                                            pdfBufferStream.push(pdfBuffers);
                                            pdfBufferStream.push(null);
                                            archive.append(pdfBufferStream, { name: `${pacientenombre}/${nombreExamen}.pdf` });
                                        }
                                        break;
                                    //Audiometria
                                    case '003':
                                        ...
                                        if (objresponse.pb_009 !== 'N' && objresponse.pb_009 !== 'SIN RESULTADOS') {
                                            ...
                                            if (codpru_id1 && parexa_id1) {
                                                if (doc_adjunto !== '0' && doc_adjunto.length > 0) {
                                                    ...
                                                    // Asegúrate de que pdfBuffers es un arreglo de Buffers
                                                    pdfBuffers.forEach(buffer => {
                                                        pdfBufferStream.push(buffer); // Pasar cada Buffer individualmente
                                                    });

                                                    pdfBufferStream.push(null); // Indicar el fin del stream
                                                    archive.append(pdfBufferStream, { name: `${pacientenombre}/${nombreExamen}.pdf` });
                                                }
                                            } else {
                                                let ArrayLaboratorio = [];
                                    ...
                                    case '013':
                                        if (objresponse.pb_013 !== 'N' && objresponse.pb_013 !== 'SIN RESULTADOS') {
                                            ...
                                            // Añadir el PDF combinado al ZIP con el nombre del ID
                                            archive.append(combinedPdfBufferStream, { name: `${pacientenombre}/${nombreExamen}.pdf` });
                                        }
                                        break;
                                    //FichaMedicoOcupacional312
                                    case '020':
                                    ...
                                    case '032':
                                        if (objresponse.pb_032 !== 'N' && objresponse.pb_032 !== 'SIN RESULTADOS') {
                                            const dataJSON = JSON.parse(objresponse.pb_032);
                                            const { superf_id, tiem_lab, prin_riesgos, med_seguridad, historia_familiar, accid_enfer, habitos, otras_observ,
                                                cod_present, cod_postura, dis_ritmo, dis_tono, dis_articulacion, ori_tiempo, ori_espacio, ori_persona, pro_cog_lucido_atento, pro_cog_pensamiento, pro_cog_percepcion,
                                                pro_cog_memoria, pro_cog_inteligencia, pro_cog_apetito, pro_cog_sueño, re_nivel_inte, re_coord_visomotriz, re_nivel_memoria, re_personalidad, re_afectividad,
                                                con_area_cognitiva, con_area_emocional, tipresult_id, conclusionesPsico, lugarNacimiento, lugarResidencia, diaAte, mesAte, anioAte,
                                                conducta_sexual, nomarch, medapmn, des_esp, med_cmp, med_firma } = dataJSON[0];
                                            ...
                                            let { mot_eva, recomendacionesInforme } = dataJSON[0];
                                    ...
                                    case '045':
                                        if (objresponse.pb_045 !== 'N' && objresponse.pb_045 !== 'SIN RESULTADOS') {
                                            const dataJSON = JSON.parse(objresponse.pb_045);
                                            const { tipexa_id, con_eva_psicologica, con_radiograficas, con_audiometria,
                                                con_espirometria, con_musculo_esqueletica, nombreExamenInfo, con_oftalmologia, con_electrocardiograma } = dataJSON[0];
                                            ...
                                            pdfBufferStream.push(pdfBuffers);
                                            pdfBufferStream.push(null);
                                            archive.append(pdfBufferStream, { name: `${pacientenombre}/${nombreExamenInfo}.pdf` });
                                        }
                                        break;
                                    ...
                                    case '046':
                                        if (objresponse.pb_046 !== 'N' && objresponse.pb_046 !== 'SIN RESULTADOS') {
                                            const dataJSON = JSON.parse(objresponse.pb_046);
                                            const { nompro, ap_alergias, tipresult_id, restricciones,
                                                tiemval_cermed, fecvcto_cermed, cadcermed, nombreExamenCerti } = dataJSON[0];
                                            ...
                                            pdfBufferStream.push(pdfBuffers);
                                            pdfBufferStream.push(null);
                                            archive.append(pdfBufferStream, { name: `${pacientenombre}/${nombreExamenCerti}.pdf` });
                                        }
                                        break;
                                    case '048':
                                        if (objresponse.pb_048 !== 'N' && objresponse.pb_048 !== 'SIN RESULTADOS') {
    ...
    async getpacientesdescargalist(req, res) {
        let { fechainicio, fechafin, paciente, protocolo, empresa } = req.query;
        const pool = await getConnection();
        const pacientescitados = await pool.query(`pa_SelPacientesDescargaList '${fechainicio}','${fechafin}', '${paciente}', '${protocolo}','${empresa}'`);
