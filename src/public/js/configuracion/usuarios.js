...
function getusuarios() {
    let parametro = document.getElementById('usuariomodal').value;
    mostrarDiv('carga');
    ...
    $.ajax({
        ...
        success: function (usuarios) {
            ...
            if (usuarios.length === 0) {
                tbodyusu.append(`
                    <tr>
                        <td colspan="4" class="text-center">No hay resultados disponibles </td>
                    </tr>
                `);
            } else {
            ...
            <tr>             
              ...
              <td>
              <a title="Resetear contraseña de usuario" type="button" class="btn btn-circle btn-sm btn-info mr-1" onclick=resetearPass(${usuario.iduser},'${usuario.usuario}') ><i class="fa-solid fa-street-view"></i></a>
              <button title="Editar usuario" onclick="getusuariosm('${usuario.iduser}','${usuario.usuario}','${usuario.Nombres}','${usuario.app}','${usuario.apm}','${usuario.DNI}','${usuario.celular}','${usuario.fecnac}','${usuario.correo}','${usuario.direccion}','${usuario.codrol}','${usuario.sexo}',${usuario.med_id},'${usuario.medapmn}')" class="btn btn-circle btn-sm btn-info mr-1"><i class="fa-solid fa-plus"></i></button>
              <a title="Eliminar usuario" style="color:white" type="button" class="btn btn-circle btn-sm btn-danger mr-1" onclick=eliminarUser("${usuario.iduser}")><i class="fa-solid fa-trash-can"></i></a>
              </td>
            </tr>
          `);
                });
