            ...
            parametros.forEach(parametro => {
                if (parametro.statitulo === 'V') {
                    ...
                    <tr >
                        ...
                        <td style="padding-bottom: 0px; padding-top: 0px; vertical-align: middle;"> 
                        <input style="display:none" type="text" id="input${parametro.parexa_id}" value="${parametro.parexa_id}" > 
                        <input style="height: 25px;" type="text" oninput="limitarInput(event,20)" data-nombre="Resultado" id="valor${parametro.parexa_id}" class="form-control " value="${parametro.resultvalor}"></td>
...
function Grabar() {
    ...
    if (tbody.rows.length > 0) {
        ...
        mensaje('error', 'Por favor, seleccione alguna prueba', 2000);
