$(document).ready(function () {
    cargarEquipo();//carga de equipo
    $("#tiem_exp_hrs").inputmask("numeric", {
        rightAlign: false,
        radixPoint: "",
        min: 0,
        max: 24,
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result[0].mensaje != 'sin datos') {
						...
						$("#ante_audio").val(result[0].ante_audio);
...
function setupOnChange() {
    const elementIdD = ["va_d_125", "va_d_250", "va_d_500", "va_d_1000", "va_d_2000", "va_d_3000", "va_d_4000", "va_d_6000", "va_d_8000", "vo_d_125", "vo_d_250", "vo_d_500", "vo_d_1000", "vo_d_2000", "vo_d_3000", "vo_d_4000", "vo_d_6000", "vo_d_8000"];
    ...
    const elementIdI = ["va_i_125", "va_i_250", "va_i_500", "va_i_1000", "va_i_2000", "va_i_3000", "va_i_4000", "va_i_6000", "va_i_8000", "vo_i_125", "vo_i_250", "vo_i_500", "vo_i_1000", "vo_i_2000", "vo_i_3000", "vo_i_4000", "vo_i_6000", "vo_i_8000"];
