...
function obtenerDataAgudeza_visual() {
    ...
    $('#agudeza_visual tbody tr').each(function () {
        ...
        var rowData = {
            texto: texto,
            sincorrecionlejos: sincorrecionlejos.convertirmayus(),
            concorrecionlejos: concorrecionlejos.convertirmayus(),
            agujeroestenopeico: agujeroestenopeico.convertirmayus(),
            sincorrecioncerca: sincorrecioncerca.convertirmayus(),
            concorrecioncerca: concorrecioncerca.convertirmayus()
        };
        data.push(rowData);
    });
    return data;
...
function obtenerDataParametros() {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        if (input.length >= 2 && input[0].value.trim() !== '') {
            ...
            var resultado_test = input[0].value.convertirmayus();
...
function obtenerDataRefraccion() {
    var data = {
        lodesfera: $('#lodesfera').val().convertirmayus(),
        lodcilindro: $('#lodcilindro').val().convertirmayus(),
        lodeje: $('#lodeje').val().convertirmayus(),
        lodav: $('#lodav').val().convertirmayus(),
        loiesfera: $('#loiesfera').val().convertirmayus(),
        loicilindro: $('#loicilindro').val().convertirmayus(),
        loieje: $('#loieje').val().convertirmayus(),
        loiav: $('#loiav').val().convertirmayus(),
        loddip: $('#loddip').val().convertirmayus(),
        codesfera: $('#codesfera').val().convertirmayus(),
        codcilindro: $('#codcilindro').val().convertirmayus(),
        codeje: $('#codeje').val().convertirmayus(),
        codav: $('#codav').val().convertirmayus(),
        coiesfera: $('#coiesfera').val().convertirmayus(),
        coicilindro: $('#coicilindro').val().convertirmayus(),
        coieje: $('#coieje').val().convertirmayus(),
        coiav: $('#coiav').val().convertirmayus(),
        coddip: $('#coddip').val().convertirmayus(),
    };
    return data;
};