...
function guardarequipos() {
    let camposValidosEQUIPO = validarFormulario('desequi,fecfab,soexa');
    if (!camposValidosEQUIPO) {
        return;
    }
...
function limpiarinse() {
    ...
    var selects = document.querySelectorAll('.needs-validation select');
