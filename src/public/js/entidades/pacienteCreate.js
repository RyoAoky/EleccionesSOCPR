...
function Grabar() {
    ...
    let ippais = $('#ippais');
    let inputid = $('#inputid');
    var validar = validarFormulario2('des_ubigeo1, appaterno,apmaterno,nombres,fecnac,cod_ubigeo,docide,numdoc,dirpac,cod_ubigeo2,correo,telefono,celular,numhijos,numdep,pcd,sexo_id,grainst_id,estciv_id,codtipcon,ippais');
    if (!validar) {
